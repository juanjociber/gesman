<?php 
    ...
    function FnListarOrigenes($conmy, $search) {
        try {
            $datos=array();
            $stmt=$conmy->prepare("select idorigen, origen from man_origenes where idcliente=:CliId and estado=2 and origen like :Nombre limit 15;");
