...
<body>
  ...
  <div class="container section-top">
    ...
    <div class="row border-bottom mb-2 pb-1">
      <div class="col-6 mb-2">
        <button type="button" class="btn btn-outline-primary form-control" onclick="FnModalAgregarSistema(); return false;"><i class="fas fa-plus"></i> SISTEMA</button>
      </div>
      <div class="col-6 mb-2">
        <button type="button" class="btn btn-outline-primary form-control" onclick="FnBuscarSistemas(); return false;"><i class="fas fa-search"></i> BUSCAR</button>
      </div>
    </div>
        
    <div class="row mb-2" id="tblSistemas">
        <div class="col-12">
  ...
  <div class="modal fade" id="modalAgregarSistema" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-primary" onclick="FnAgregarSistema(); return false;">GUARDAR</button>
        </div>              
      </div>
    </div>
  </div>

  <div class="modal fade" id="modalModificarSistema" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">MODIFICAR SISTEMA</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body pb-1 mb-1">
          <div class="row">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-primary" onclick="FnModificarSistema(); return false;">GUARDAR</button>
        </div>              
      </div>
    </div>
  </div>
  ...
  <script src="/gesman/js/Sistemas.js"></script>
