  ...
  require_once $_SERVER['DOCUMENT_ROOT']."/gesman/data/OrdenesData.php";
	...
	try{
        ...
        if(!empty($ORDEN['id'])){
            ...
            $ARCHIVOS=FnBuscarArchivos($conmy, array('refid'=>$_GET['id'], 'tabla'=>'ORD', 'tipo'=>'IMG'));
...
<head>
    ...
    @media print {
      body {
        ...
        height: auto !important; /* Permitir que el body crezca según el contenido */
      }
      html {
        border: none !important;
      ...
      .container-loader-full, .fa-plus-square {
        display: none;
      }
    }
	</style>
...
<body>
  ...
  <script>
    window.addEventListener('beforeprint', () => {
      ...
      body.insertBefore(headerClone, body.firstChild);
    });
    window.addEventListener('afterprint', () => {
      const headerClone = document.querySelector('.header-print');
      headerClone.remove();
    });
  </script>
