<?php 
    ...
    if(!isset($_SESSION['UserName']) || !isset($_SESSION['CliId']) || !isset($_SESSION['RolMan'])){
    ...
    /*if($_SESSION['RolMan'] < 2){
      ...
      echo 'No estás autorizado para acceder a este recurso.';
      exit();
    }*/
?>
...
<head>
    ...
    <title>Contactos | GPEM SAC</title>
...
<body>
  ...
  <div class="container section-top">
    ...
    <div class="row border-bottom mb-2 pb-1">
      <div class="col-6 mb-2">
        <button type="button" class="btn btn-outline-primary form-control" onclick="FnModalAgregarContacto(); return false;"><i class="fas fa-plus"></i> CONTACTO</button>
      </div>
      <div class="col-6 mb-2">
        <button type="button" class="btn btn-outline-primary form-control" onclick="FnBuscarContactos(); return false;"><i class="fas fa-search"></i> BUSCAR</button>
      </div>
    </div>
        
    <div class="row mb-2" id="tblContactos">
        <div class="col-12">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-primary" onclick="FnAgregarContacto(); return false;">GUARDAR</button>
        </div>              
      </div>
    </div>
  </div>

  <div class="modal fade" id="modalModificarContacto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-primary" onclick="FnModificarContacto(); return false;">GUARDAR</button>
        </div>              
      </div>
    </div>
  </div>
  ...
  <script src="/gesman/js/Contactos.js"></script>
