    ...
    <div class="container section-top">
        <div class="row mb-3 gpem-hide-print">
            <div class="col-12 btn-group" role="group" aria-label="Basic example">
                ...
                ?>
                <button type="button" class="btn btn-outline-primary fw-bold" onclick="FnOrdenResumen(<?php echo $_GET['id'];?>); return false;"><i class="fas fa-print"></i><span class="d-none d-sm-block"> Imprimir</span></button>
                <?php
