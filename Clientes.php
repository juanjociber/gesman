...
<body>
  ...
  <div class="container section-top">
    ...
    <div class="row mb-2" id="tblClientes">
        <div class="col-12">
        ...
        <div class="modal-body pb-1 mb-1">
          <div class="row">
            <div class="col-12 mb-2">
              ...
              <input type="text" class="form-control" id="txtRuc2">
            </div>
            <div class="col-12 mb-2">
              <p class="m-0 text-secondary" style="font-size: 12px;">Razon Social</p>
              <input type="text" class="form-control" id="txtNombre2">
            </div>                      
            <div class="col-12 mb-2">
              <p class="m-0 text-secondary" style="font-size:12px;">Nombre Corto</label>
              <input type="text" class="form-control" id="txtAlias2"/>
            </div>
            <div class="col-12 mb-2">
              <p class="m-0 text-secondary" style="font-size:12px;">Dirección</label>
              <input type="text" class="form-control" id="txtDireccion2"/>
            </div>
            <div class="col-6 mb-2">
              <p class="m-0 text-secondary" style="font-size:12px;">ID ODOO</label>
              <input type="number" class="form-control" id="txtOdoId2" value="0"/>
            </div>
            <div class="col-6 mb-2">
              <p class="m-0 text-secondary" style="font-size:12px;">ID Almacén ODOO</label>
              <input type="number" class="form-control" id="txtAlmId2" value="0"/>
            </div>   
          </div>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body pb-1 mb-1">
          <div class="row">
            <div class="col-12 mb-2">
              <p class="m-0 text-secondary" style="font-size: 12px;">RUC</p>
              <input type="text" class="form-control" id="txtRuc3" readonly/>
            ...
            <div class="col-12 mb-2">
              <p class="m-0 text-secondary" style="font-size:12px;">Nombre Corto</label>
              <input type="text" class="form-control" id="txtAlias3"/>
            </div>
            <div class="col-12 mb-2">
              <p class="m-0 text-secondary" style="font-size:12px;">Dirección</label>
              <input type="text" class="form-control" id="txtDireccion3"/>
            </div>
            <div class="col-6 mb-2">
              <p class="m-0 text-secondary" style="font-size:12px;">ID ODOO</label>
              <input type="number" class="form-control" id="txtOdoId3" value="0"/>
            </div>
            <div class="col-6 mb-2">
              <p class="m-0 text-secondary" style="font-size:12px;">ID Almacén ODOO</label>
              <input type="number" class="form-control" id="txtAlmId3" value="0"/>
            </div>
            <div class="col-6 mb-2">
  ...
  <script src="/gesman/js/Clientes.js"></script>
