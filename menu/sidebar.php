...
<header class="gpem-hide-print">
    <div style="display: flex; align-items: center;">
        ...
        <div style="align-self: center; flex: 1 0 0%;">
            <label class="menu-user m-0"><a class="btn btn-outline-danger btn-sm text-white font-weight-bold" href="/gesman/Salir.php" role="button"><i class="fas fa-sign-out-alt"></i><span class="user-hidden"><?php echo $_SESSION['gesman']['Nombre']; ?></span></a></label>
        </div>
    </div>
        ...
        <ul class="menu ps-0">
            ...
            <?php 
                if(FnValidarSesionManNivel2()){
                    echo '<li><a href="/solicitudes/Solicitudes.php" id="MenuSolicitudes"><i class="fas fa-list icon-menu"></i> Solicitudes</a></li>';
                }
            ?>
            <?php 
                if(FnValidarSesionManNivel1()){
                    echo '<li><a href="/checklists/CheckLists.php" id="MenuCheckLists"><i class="fas fa-list icon-menu"></i> CheckLists</a></li>';
                }
            ?>
            <?php 
                if(FnValidarSesionManNivel2()){
